function store() {
  ...
  var time = document.getElementById('momentBrand').value;
  ...
  window.localStorage.setItem(key, JSON.stringify(moment));
...
window.onload = function () {
  ...
  document.getElementById('momentForm').onsubmit = store;
